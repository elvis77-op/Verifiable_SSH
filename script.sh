...
#	echo "knownhost exists"
	...
	#echo "1-st"
	#cat /root/keys/known_hosts
	#ssh-keyscan -p $port -H $hostname >> /root/keys/known_hosts
	#read input
	#cp /root/keys/known_hosts /root/.ssh/known_hosts	
	#echo "2-nd"
	#cat /root/keys/known_hosts	
	echo "load scripts"
